export default function generateSVG(stats, pwa) {
  const data = stats.map((value) => {
    ...
    const classValue =
      value < 50 ? "guage-red" : value < 90 ? "guage-orange" : "guage-green";
    return { value, dataArc, class: classValue };
  });
  ...
  return `
        ...
        data[0].class
      }" viewBox="0 0 200 200" width="200" height="200" x="0" y="0">
        ...
        data[1].class
      }" viewBox="0 0 200 200" width="200" height="200" x="200" y="0">
				<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"/>
        ...
        data[2].class
      }" viewBox="0 0 200 200" width="200" height="200" x="400" y="0">
				<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"/>
        ...
        data[3].class
      }" viewBox="0 0 200 200" width="200" height="200" x="600" y="0">
				<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"/>
			...
			<svg class="guage-div guage-pwa " viewBox="0 0 200 200" width="200" height="200" x="800" y="0">
				<svg viewBox="0 0 60 60" width="112" height="112" x="44" y="4">
					...
					<g stroke="none" fill-rule="nonzero">
						...
						<!-- No badges. -->
						<rect class="lh-gauge--pwa__component lh-gauge--pwa__na-line lh-gauge--pwa__${
              pwa === 0 ? "visible" : "invisible"
            }" fill="#FFFFFF" x="20" y="32" width="20" height="4" rx="2"/>
						<!-- Just fast and reliable. -->
						<g class="lh-gauge--pwa__component lh-gauge--pwa__fast-reliable-badge lh-gauge--pwa__${
              pwa === 1 ? "visible" : "invisible"
						...
						<!-- Just installable. -->
						<g class="lh-gauge--pwa__component lh-gauge--pwa__installable-badge lh-gauge--pwa__${
              pwa === 2 ? "visible" : "invisible"
            }" transform="translate(20, 29)">
						...
						<g class="lh-gauge--pwa__component lh-gauge--pwa__fast-reliable-installable-badges lh-gauge--pwa__${
              pwa === 3 ? "visible" : "invisible"
            }">
						...
						<!-- Full PWA. -->
						<g class="lh-gauge--pwa__component lh-gauge--pwa__check-circle lh-gauge--pwa__${
              pwa === 4 ? "visible" : "invisible"
